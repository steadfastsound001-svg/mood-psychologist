...
инструмент — скальпель. без воды, без цензуры. жёсткое — говоришь. ваня платит за правду, не за поглаживания.
...
async def cmd_month(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    if update.effective_user.id != USER_ID:
        return
    await update.message.chat.send_action("typing")
    await stream_reply(update, context, "", mode="month", max_tokens=350, task="reasoning")
