...
agent_config.register("cache_ttl", "1h", "Срок жизни кэша промпта",
                      "5m или 1h. Личность — 11.5k токенов в каждом запросе; кэш снимает "
                      "с них 90% цены, но живёт ограниченно. Разговор идёт с паузами, "
                      "поэтому 1h: лишняя запись стоит 0.75× входа, а каждое попадание "
                      "экономит 0.9× — окупается с первой же паузы длиннее пяти минут.",
                      "setting", 3)
