...
формат — лаконичный и минималистичный (700-1400 знаков, не больше):
— ровно 4 блока, каждый: эмодзи + **жирный заголовок** в одну строку, например: 🧭 **кто ты**
— блоки: кто ты · как ты устроен · что цепляет (уязвимое, мягко) · что помогает
— под каждым заголовком — 1-2 коротких ёмких предложения. без списков и буллетов.
— между блоками — пустая строка. **жирным** — только 1 ключевое слово на блок.

правила:
— строчные буквы (и заголовки тоже), живой язык, без терминов и без воды
— коротко: лучше меньше слов, но точнее. режь всё лишнее.
— только из данных, не выдумывай
— НЕ пиши инструкций «как с тобой работать»
— НИКАКИХ таблиц, никаких ## и | и markdown кроме **жирного** и эмодзи в заголовке
— тон: спокойный наставник, который видит тебя насквозь и на твоей стороне
